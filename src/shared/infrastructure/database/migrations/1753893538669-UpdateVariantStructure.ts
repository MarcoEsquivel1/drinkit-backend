...
export class UpdateVariantStructure1753893538669 implements MigrationInterface {
  name = 'UpdateVariantStructure1753893538669';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "variants" DROP COLUMN "deactivatedAt"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "variants" ADD "price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "variants" DROP COLUMN "price"`);
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "variants" ADD "deactivatedAt" date`);
    await queryRunner.query(
